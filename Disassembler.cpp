...
#define BIND_MNEMONIC_TO_INSTRUCTION_TYPE(mn, new_t)\
	...
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("lwl", INS_LWL);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("lwr", INS_LWR);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("swl", INS_SWL);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("swr", INS_SWR);
	...
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("bc1t", INS_BC1T);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("bc1f", INS_BC1F);
	...
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("mtc1", INS_MTC1);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("lwc1", INS_LWC1);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("ldc1", INS_LDC1);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("swc1", INS_SWC1);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("sdc1", INS_SDC1);

	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("cvt.d.w", INS_CVT_D_W);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("cvt.d.s", INS_CVT_D_S);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("cvt.s.d", INS_CVT_S_D);

	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("div.s", INS_DIV_S);
	BIND_MNEMONIC_TO_INSTRUCTION_TYPE("div.d", INS_DIV_D);
